...
set projname=sbom-tool
set CLONE_LINK="https://github.com/microsoft/sbom-tool.git"
...
sbom-tool.exe generate -bc %REPO_Path%\src -b %REPO_Path% -pn MULLER_PackageName -ps MULLER_PackageSupplier -pv MULLER_PackageVersion_0.0 -nsb http://MULLER_DEREK.sbom >> %DOCPATH%\%projname%_commands_log.txt
dir %REPO_Path% /a >> %DOCPATH%\%projname%_commands_log.txt
